...
const Toolbar: React.FC<ToolbarProps> = ({
  editor, onSave, onPrint, onClear, onExportHtml, isSaving, saveSuccess,
  ...
  return (
    <div className="no-print bg-white/90 backdrop-blur-md border-b border-slate-200 p-2 flex flex-wrap items-center gap-1 sticky top-0 z-[100] shadow-sm px-4">
      ...
      <div className="flex items-center gap-0.5">
        ...
        <ToolbarButton
          onClick={addImage}
          title="Imagem (Arraste para inserir)"
          draggable onDragStart={(e: any) => e.dataTransfer.setData('application/x-tiptap-drag-type', 'image')}
        >
          <ImageIcon size={16} />
        </ToolbarButton>
        ...
        <ToolbarButton
          ...
          title="Linha (Arraste para inserir)"
          draggable onDragStart={(e: any) => e.dataTransfer.setData('application/x-tiptap-drag-type', 'horizontalRule')}
        >
          <Minus size={16} />
        </ToolbarButton>
      </div>
